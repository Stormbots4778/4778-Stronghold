...
import org.usfirst.frc.team4778.robot.commands.autonomous.Moat;
...
public class Robot extends IterativeRobot {
	...
	public void updateSmartDashboard() {
		...
		// SmartDashboard.putNumber("NavX Pitch (Actually Roll)",
		// RobotMap.ahrs.getPitch());
		// SmartDashboard.putNumber("NavX Yaw", RobotMap.ahrs.getYaw());
		// SmartDashboard.putNumber("NavX Roll (Actually Pitch)",
		// RobotMap.ahrs.getRoll());

		// SmartDashboard.putNumber("Heading ", RobotMap.h);
		// SmartDashboard.putNumber("Encoder L: ",
		// RobotMap.leftdrive.getDistance());
		// SmartDashboard.putNumber("Encoder R: ",
		// RobotMap.rightdrive.getDistance());
	}
