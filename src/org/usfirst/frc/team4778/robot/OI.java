...
public class OI {
	...
	public static Joystick xbox2 = new Joystick(4); // Backup controller for
													// button board
	...
	// public static Button manip2 = new JoystickButton(nip, 1); // TODO Set
	// port
	...
	public OI() {
		...
		manip.whileHeld(new OISwitch(true, 1, true)); // sets the arm for the
														// switch on the
		// manip2.whileHeld(new OISwitch(false, 2, true)); // sets the arm for
		// the switch on the
